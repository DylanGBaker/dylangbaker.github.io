...
function InitialiseFilePaths() {
  ...
  } else if (window.location.pathname == "/Design/design.html") {
    filePaths = [
      "../index.html",
      "../Blogs/blog.html",
      "design.html",
  ...
  } else if (window.location.pathname == "/Portfolio/portfolio.html") {
    filePaths = [
      "../index.html",
      "../Blogs/blog.html",
      "../Design/design.html",
  ...
  } else if (window.location.pathname == "/Contact/contact.html") {
    filePaths = [
      "../index.html",
      "../Blogs/blog.html",
      "../Design/design.html",
